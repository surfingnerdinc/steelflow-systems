...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: t("email"),
      content: "Biuro: biuro@steelflow.pl\nSzymon: szymon@steelflow.pl\nAndrzej: andrzej@steelflow.pl",
    },
  ];
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="py-32 md:py-48 bg-gray-50 dark:bg-gray-950"
    >
      <div className="container mx-auto px-8 sm:px-12 lg:px-16 max-w-7xl">
        ...
        >
          ...
          <p className="text-2xl md:text-3xl text-gray-600 dark:text-gray-400 font-light leading-relaxed max-w-3xl">
            {t("subtitle")}
          </p>
        </motion.div>
